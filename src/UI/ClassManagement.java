 ...
 * @author Pouya
 */
public class ClassManagement extends Director implements DataBluePrint {
        DataEngine RoomData = new DataEngine("RoomClass.txt");
    /**
    ...
    private void initComponents() {
        ...
        TClass.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        TClass.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        TClass.setText("Class Type");
        TClass.setBorder(null);
        ...
        TPrice.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(TClass, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(TClass, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
// TODO add your handling code here:
    ...
    private void RRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RRemoveActionPerformed
        ...
        @Override
        public void Add () {
            Boolean validation = IntValidation (TPrice.getText()) & !TClass.getText().equals("Room Type");
            if (validation == true) {
                StringBuilder sb = new StringBuilder();
                sb.append("Class.").append(TClass.getText()).append("\t");
                if (RoomData.Validate(sb.toString()) == false) {
                sb.append("Price.").append(TPrice.getText()).append("\t");
                RoomData.Append(sb.toString());
                JOptionPane.showMessageDialog(null, "Database Updated Successfully");
                }
                else {
                    JOptionPane.showMessageDialog(null, "The Exact Same Room Type Exists In The System DataBase.");
                }
            }
            else {
                JOptionPane.showMessageDialog(null, "An Error Occured Due To One Of These Reasons:\n1- The Price Must Be An Integer\n2- A Room Type Is Required.");
            }
}
        @Override
        ...
        public Boolean Delete () {
            if (RoomData.Validate("Class."+TClass.getText())) {
                RoomData.Delete("Class."+TClass.getText());
                JOptionPane.showMessageDialog(null, "Database Updated Successfully");
                return true;
            }
            else {
