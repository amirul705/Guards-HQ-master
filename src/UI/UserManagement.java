 ...
 * @author Pouya
 */
public class UserManagement extends Director implements DataBluePrint {
        DataEngine UserData = new DataEngine("UserList.txt");
        DataEngine LoginData = new DataEngine("Login.txt");
    /**
    ...
    private void initComponents() {
        ...
        CDepartment.setBackground(new java.awt.Color(148, 143, 153));
        CDepartment.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        CDepartment.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Department", "Reservation Staff", "Front Desk Staff", "Cleaning Staff" }));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(Password, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(CDepartment, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(CDepartment, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
...
// TODO add your handling code here:
    ...
    private void RAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RAddActionPerformed
        ...
        DeActivate (TID);
        Activate (TFullName, TNRIC, TContactNumber, RFemale, RMale, CDepartment);
// TODO add your handling code here:
    ...
    private void RRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RRemoveActionPerformed
        Activate (TID);
        DeActivate (TFullName, TNRIC, TContactNumber, RFemale, RMale, CDepartment, Password);
        // TODO add your handling code here:
    ...
    private void RUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RUpdateActionPerformed
        Activate (TFullName, TNRIC, TContactNumber, RFemale, RMale, CDepartment, Password, TID);
        // TODO add your handling code here:
        ...
        public void Add () {
            ...
            try {
               ...
               Validate = Validate & (!Password.getText().equals("Password"));
               Validate = Validate & (CDepartment.getSelectedIndex()>0);
               if (Validate == true) {
                   if (RMale.isSelected()){
                       ...
                       sb.append("Department.").append(CDepartment.getSelectedItem().toString()).append("\t");
                       UserData.Append(sb.toString());
                       sb = new StringBuilder();
                       sb.append("Username.").append(Integer.toString(IDNumber)).append("\t");
                       sb.append("Password.").append(Password.getText()).append("\t");
                       sb.append("Role.").append(CDepartment.getSelectedItem().toString().trim()).append("\t");
        ...
        public Boolean Delete () {
            if (UserData.Validate("ID."+TID.getText())== true) {
                ...
                LoginData.Delete("Username."+TID.getText());
                JOptionPane.showMessageDialog(null, "Database Updated Successfully");                
                return true;
            }
            else {JOptionPane.showMessageDialog(null, "The Entered ID Was Not Found.");
                return false;
            }
}
    /**
